...
class TrellisImageTo3DPipeline(Pipeline):
    ...
    def from_pretrained(path: str) -> "TrellisImageTo3DPipeline":
        ...
        slat_sampler_name = args['slat_sampler']['name']
        slat_sampler_args = args['slat_sampler']['args']

        new_pipeline.slat_sampler = getattr(samplers, slat_sampler_name)(**slat_sampler_args)
        new_pipeline.slat_sampler_params = args['slat_sampler']['params']


        new_pipeline.slat_normalization = {
